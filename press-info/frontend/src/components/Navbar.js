...
import { faHome, faInfoCircle, faEnvelope, faFutbol, faCloudSun, faGlobe, faUserShield, faGamepad } from '@fortawesome/free-solid-svg-icons';
    ...
    <nav className="navbar">
      <div className="container">
        ...
        <ul className={`nav-links ${isOpen ? 'active' : ''}`}>
          ...
          {isLoggedIn ? (
            <li><Link to="/controller" onClick={closeMenu}><FontAwesomeIcon icon={faGamepad} /> تحكم</Link></li>
          ) : (
