...
return (
    <div className="containersrv">
      <header>
        <h1>مرحبًا بك في خدمات الإعلام والطقس</h1>
        <p>هنا يمكنك العثور على خدمات الإعلام الخاصة بك وإدارتها، بالإضافة إلى معلومات الطقس.</p>
        <button onClick={handleAddService}>إضافة خدمة</button>
      </header>
      <main>
        {services.length === 0 ? (
            ...
            {services.map((service) => (
              <div key={service.id} className="service-card">
                <a onClick={() => handleProductClick(service.id)}>
                  <img src={`backendhb/${service.image}`} alt="صورة الخدمة" />
                </a>
      ...
      >
        ...
        <form onSubmit={handleFormSubmit} className="modal-form">
          ...
          <div>
            ...
            <input
              placeholder="يرجى إدخال العنوان الفرعي للخبر"
              type="text"
              name="heading"
